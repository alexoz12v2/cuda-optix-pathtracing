...
# fun for each file recognized as C++/CUDA source
# Update as many times as you need
set(FORMAT_SOURCES "")
foreach(FOLDER IN ITEMS include src test benchmark examples)
  file(GLOB_RECURSE folder_files "${FOLDER}/*.h" "${FOLDER}/*.hpp" "${FOLDER}/*.c" "${FOLDER}/*.cpp" "${FOLDER}/*.cc" "${FOLDER}/*.cu" "${FOLDER}/*.cuh" "${FOLDER}/*.ixx" "${FOLDER}/*.cppm")
  # Exclude Third Party code if you insert in the aforementioned folders!
  # list(FILTER folder_files EXCLUDE REGEX)
