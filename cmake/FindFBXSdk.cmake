...
#
# sets: FBXSDK_FOUND, FBXSDK_DIR, FBXSDK_LIBRARY, FBXSDK_LIBRARY_DEBUG FBXSDK_INCLUDE_DIR
#
...
function (fbxsdk_copy_runtime runtime_var dest_dir config)
  ...
  # Copy
  execute_process(COMMAND ${CMAKE_COMMAND} -E copy_if_different "${_src}" "${_dst}" RESULT_VARIABLE _copy_result)
...
if (DMT_OS_WINDOWS)
  ...
  # set(_fbxsdk_libname_debug "libfbxsdk-md.lib") set(_fbxsdk_libname_release "libfbxsdk-md.lib")
  ...
  find_library(
    FBXSDK_LIBRARY ${_fbxsdk_libname_release}
    PATHS ${_fbxsdk_root}
    PATH_SUFFIXES ${_fbxsdk_libdir_release})
  find_library(
    FBXSDK_LIBRARY_DEBUG ${_fbxsdk_libname_debug}
    PATHS ${_fbxsdk_root}
  ...
  find_file(
    FBXSDK_RUNTIME ${_fbxsdk_dll_name}
    PATHS ${_fbxsdk_root}
    PATH_SUFFIXES ${_fbxsdk_libdir_release})
  find_file(
    FBXSDK_RUNTIME_DEBUG ${_fbxsdk_dll_name}
    PATHS ${_fbxsdk_root}
    PATH_SUFFIXES ${_fbxsdk_libdir_debug})
  ...
  # dependencies
  find_library(
    FBXSDK_ALEMBIC_LIBRARY ${_fbxsdk_alembic_libname_release}
    PATHS ${_fbxsdk_root}
    PATH_SUFFIXES ${_fbxsdk_libdir_release})
  find_library(
    FBXSDK_ALEMBIC_LIBRARY_DEBUG ${_fbxsdk_alembic_libname_debug}
    PATHS ${_fbxsdk_root}
    PATH_SUFFIXES ${_fbxsdk_libdir_debug})

  find_library(
    FBXSDK_LIBXML2_LIBRARY ${_fbxsdk_libxml2_libname_release}
    PATHS ${_fbxsdk_root}
    PATH_SUFFIXES ${_fbxsdk_libdir_release})
  find_library(
    FBXSDK_LIBXML2_LIBRARY_DEBUG ${_fbxsdk_libxml2_libname_debug}
    PATHS ${_fbxsdk_root}
    PATH_SUFFIXES ${_fbxsdk_libdir_debug})

  find_library(
    FBXSDK_ZLIB_LIBRARY ${_fbxsdk_zlib_libname_release}
    PATHS ${_fbxsdk_root}
    PATH_SUFFIXES ${_fbxsdk_libdir_release})
  find_library(
    FBXSDK_ZLIB_LIBRARY_DEBUG ${_fbxsdk_zlib_libname_debug}
    PATHS ${_fbxsdk_root}
    PATH_SUFFIXES ${_fbxsdk_libdir_debug})
...
elseif (DMT_OS_LINUX)
  ...
  find_library(
    FBXSDK_LIBRARY ${_fbxsdk_libname}
    PATHS ${_fbxsdk_root}
    PATH_SUFFIXES ${_fbxsdk_libdir_release})
  find_library(
    FBXSDK_LIBRARY_DEBUG ${_fbxsdk_libname}
    PATHS ${_fbxsdk_root}
    PATH_SUFFIXES ${_fbxsdk_libdir_debug})

  find_library(
    FBXSDK_RUNTIME ${_fbx_runtime_lib}
    PATHS ${_fbxsdk_root}
    PATH_SUFFIXES ${_fbxsdk_libdir_release})
  find_library(
    FBXSDK_RUNTIME_DEBUG ${_fbx_runtime_lib}
    PATHS ${_fbxsdk_root}
    PATH_SUFFIXES ${_fbxsdk_libdir_debug})

  find_library(
    FBXSDK_ALEMBIC_LIBRARY ${_fbxsdk_alembic_libname}
    PATHS ${_fbxsdk_root}
    PATH_SUFFIXES ${_fbxsdk_libdir_release})
  find_library(
    FBXSDK_ALEMBIC_LIBRARY_DEBUG ${_fbxsdk_alembic_libname}
    PATHS ${_fbxsdk_root}
    PATH_SUFFIXES ${_fbxsdk_libdir_debug})
