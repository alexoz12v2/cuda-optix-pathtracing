# straight from nvidia docs: https://github.com/NVIDIA/OptiX_Apps/blob/master/3rdparty/CMake/nvcuda_compile_module.cmake
# Generate a custom build rule to translate *.cu files to *.ptx or *.optixir files. NVCUDA_COMPILE_MODULE( SOURCES
# file1.cu file2.cu DEPENDENCIES header1.h header2.h TARGET_PATH <path where output files should be stored> EXTENSION
# ".ptx" | ".optixir" GENERATED_FILES program_modules NVCC_OPTIONS -arch=sm_50 )

# Generates *.ptx or *.optixir files for the given source files. The program_modules argument will receive the list of
# generated files. DAR Using this because I do not want filenames like "cuda_compile_ptx_generated_raygeneration.cu.ptx"
# but just "raygeneration.ptx".
...
function (NVCUDA_COMPILE_MODULE)
  ...
  foreach (input ${NVCUDA_COMPILE_MODULE_SOURCES})
    ...
    # This prints the standalone NVCC command line for each CUDA file. CUDAToolkit_NVCC_EXECUTABLE has been set with
    # FindCUDAToolkit.cmake in CMake 3.17 and newer. message("${CUDAToolkit_NVCC_EXECUTABLE} "
