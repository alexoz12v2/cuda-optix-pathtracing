...
#define WGL_OML_sync_control 1
    ...
    typedef void *(GLAD_API_PTR *PFNWGLALLOCATEMEMORYNVPROC)(
      GLsizei size,
      GLfloat readfreq,
      GLfloat writefreq,
      GLfloat priority);
    ...
    typedef GLboolean(GLAD_API_PTR *PFNWGLBINDDISPLAYCOLORTABLEEXTPROC)(
      GLushort id);
    typedef BOOL(
      GLAD_API_PTR *PFNWGLBINDSWAPBARRIERNVPROC)(GLuint group, GLuint barrier);
    ...
    typedef GLboolean(GLAD_API_PTR *PFNWGLCREATEDISPLAYCOLORTABLEEXTPROC)(
      GLushort id);
    typedef LPVOID(GLAD_API_PTR *PFNWGLCREATEIMAGEBUFFERI3DPROC)(
      HDC   hDC,
      DWORD dwSize,
      UINT  uFlags);
    typedef HGLRC(
      GLAD_API_PTR *PFNWGLCREATELAYERCONTEXTPROC)(HDC hDc, int level);
    ...
    typedef BOOL(GLAD_API_PTR *PFNWGLDXLOCKOBJECTSNVPROC)(
      HANDLE  hDevice,
      GLint   count,
      HANDLE *hObjects);
    typedef BOOL(
      GLAD_API_PTR *PFNWGLDXOBJECTACCESSNVPROC)(HANDLE hObject, GLenum access);
    ...
    typedef BOOL(GLAD_API_PTR *PFNWGLDXSETRESOURCESHAREHANDLENVPROC)(
      void  *dxObject,
      HANDLE shareHandle);
    typedef BOOL(GLAD_API_PTR *PFNWGLDXUNLOCKOBJECTSNVPROC)(
      HANDLE  hDevice,
      GLint   count,
      HANDLE *hObjects);
    typedef BOOL(GLAD_API_PTR *PFNWGLDXUNREGISTEROBJECTNVPROC)(
      HANDLE hDevice,
      HANDLE hObject);
    typedef BOOL(
      GLAD_API_PTR *PFNWGLDELAYBEFORESWAPNVPROC)(HDC hDC, GLfloat seconds);
    ...
    typedef VOID(GLAD_API_PTR *PFNWGLDESTROYDISPLAYCOLORTABLEEXTPROC)(
      GLushort id);
    typedef BOOL(
      GLAD_API_PTR *PFNWGLDESTROYIMAGEBUFFERI3DPROC)(HDC hDC, LPVOID pAddress);
    ...
    typedef BOOL(GLAD_API_PTR *PFNWGLENUMGPUSFROMAFFINITYDCNVPROC)(
      ...
      HGPUNV *hGpu);
    typedef BOOL(
      GLAD_API_PTR *PFNWGLENUMGPUSNVPROC)(UINT iGpuIndex, HGPUNV *phGpu);
    ...
    typedef BOOL(
      GLAD_API_PTR *PFNWGLGENLOCKSAMPLERATEI3DPROC)(HDC hDC, UINT uRate);
    typedef BOOL(
      GLAD_API_PTR *PFNWGLGENLOCKSOURCEDELAYI3DPROC)(HDC hDC, UINT uDelay);
    typedef BOOL(
      GLAD_API_PTR *PFNWGLGENLOCKSOURCEEDGEI3DPROC)(HDC hDC, UINT uEdge);
    typedef BOOL(
      GLAD_API_PTR *PFNWGLGENLOCKSOURCEI3DPROC)(HDC hDC, UINT uSource);
    ...
    typedef UINT(
      GLAD_API_PTR *PFNWGLGETGPUIDSAMDPROC)(UINT maxCount, UINT *ids);
    typedef INT(GLAD_API_PTR *PFNWGLGETGPUINFOAMDPROC)(
      ...
      UINT   size,
      void  *data);
    typedef BOOL(GLAD_API_PTR *PFNWGLGETGAMMATABLEI3DPROC)(
      HDC     hDC,
      int     iEntries,
      USHORT *puRed,
      USHORT *puGreen,
    ...
    typedef BOOL(GLAD_API_PTR *PFNWGLGETGAMMATABLEPARAMETERSI3DPROC)(
      ...
      int *piValue);
    typedef BOOL(
      GLAD_API_PTR *PFNWGLGETGENLOCKSAMPLERATEI3DPROC)(HDC hDC, UINT *uRate);
    typedef BOOL(
      GLAD_API_PTR *PFNWGLGETGENLOCKSOURCEDELAYI3DPROC)(HDC hDC, UINT *uDelay);
    typedef BOOL(
      GLAD_API_PTR *PFNWGLGETGENLOCKSOURCEEDGEI3DPROC)(HDC hDC, UINT *uEdge);
    typedef BOOL(
      GLAD_API_PTR *PFNWGLGETGENLOCKSOURCEI3DPROC)(HDC hDC, UINT *uSource);
    typedef int(GLAD_API_PTR *PFNWGLGETLAYERPALETTEENTRIESPROC)(
      ...
      int       cEntries,
      COLORREF *pcr);
    typedef BOOL(GLAD_API_PTR *PFNWGLGETMSCRATEOMLPROC)(
      HDC    hdc,
      INT32 *numerator,
      INT32 *denominator);
    ...
    typedef BOOL(GLAD_API_PTR *PFNWGLGETSYNCVALUESOMLPROC)(
      HDC    hdc,
      INT64 *ust,
      INT64 *msc,
      INT64 *sbc);
    ...
    typedef BOOL(
      GLAD_API_PTR *PFNWGLISENABLEDGENLOCKI3DPROC)(HDC hDC, BOOL *pFlag);
    typedef BOOL(
      GLAD_API_PTR *PFNWGLJOINSWAPGROUPNVPROC)(HDC hDC, GLuint group);
    ...
    typedef BOOL(GLAD_API_PTR *PFNWGLMAKECONTEXTCURRENTARBPROC)(
      ...
      HDC   hReadDC,
      HGLRC hglrc);
    typedef BOOL(GLAD_API_PTR *PFNWGLMAKECONTEXTCURRENTEXTPROC)(
      HDC   hDrawDC,
      HDC   hReadDC,
      HGLRC hglrc);
    typedef BOOL(
      GLAD_API_PTR *PFNWGLMAKECURRENTPROC)(HDC hDc, HGLRC newContext);
    typedef BOOL(GLAD_API_PTR *PFNWGLQUERYCURRENTCONTEXTNVPROC)(
      int  iAttribute,
      int *piValue);
    typedef BOOL(
      GLAD_API_PTR *PFNWGLQUERYFRAMECOUNTNVPROC)(HDC hDC, GLuint *count);
    ...
    typedef BOOL(GLAD_API_PTR *PFNWGLQUERYPBUFFEREXTPROC)(
      ...
      int         iAttribute,
      int        *piValue);
    typedef BOOL(GLAD_API_PTR *PFNWGLQUERYSWAPGROUPNVPROC)(
      HDC     hDC,
      GLuint *group,
      GLuint *barrier);
    ...
    typedef BOOL(GLAD_API_PTR *PFNWGLSETDIGITALVIDEOPARAMETERSI3DPROC)(
      ...
      int        iAttribute,
      const int *piValue);
    typedef BOOL(GLAD_API_PTR *PFNWGLSETGAMMATABLEI3DPROC)(
      HDC           hDC,
      int           iEntries,
      const USHORT *puRed,
    ...
    typedef BOOL(GLAD_API_PTR *PFNWGLSETPBUFFERATTRIBARBPROC)(
      ...
      const int  *piAttribList);
    typedef BOOL(
      GLAD_API_PTR *PFNWGLSETSTEREOEMITTERSTATE3DLPROC)(HDC hDC, UINT uState);
    typedef BOOL(GLAD_API_PTR *PFNWGLSHARELISTSPROC)(
      HGLRC hrcSrvShare,
      HGLRC hrcSrvSource);
    typedef INT64(GLAD_API_PTR *PFNWGLSWAPBUFFERSMSCOMLPROC)(
      HDC   hdc,
      INT64 target_msc,
      INT64 divisor,
      INT64 remainder);
    ...
    typedef BOOL(
      GLAD_API_PTR *PFNWGLSWAPLAYERBUFFERSPROC)(HDC hdc, UINT fuFlags);
    ...
    typedef BOOL(GLAD_API_PTR *PFNWGLWAITFORMSCOMLPROC)(
      ...
      INT64 *msc,
      INT64 *sbc);
    typedef BOOL(GLAD_API_PTR *PFNWGLWAITFORSBCOMLPROC)(
      HDC    hdc,
      INT64  target_sbc,
      INT64 *ust,
      INT64 *msc,
...
#define wglResetFrameCountNV glad_wglResetFrameCountNV
    GLAD_API_CALL PFNWGLRESTOREBUFFERREGIONARBPROC
      glad_wglRestoreBufferRegionARB;
...
#define wglSwapIntervalEXT glad_wglSwapIntervalEXT
    GLAD_API_CALL PFNWGLSWAPLAYERBUFFERSMSCOMLPROC
