...
namespace dmt {
    float SRGBToLinearLUT
        [256]{0.0000000000, 0.0003035270, 0.0006070540, 0.0009105810, 0.0012141080, 0.0015176350, 0.0018211619,
              0.0021246888, 0.0024282159, 0.0027317430, 0.0030352699, 0.0033465356, 0.0036765069, 0.0040247170,
              0.0043914421, 0.0047769533, 0.0051815170, 0.0056053917, 0.0060488326, 0.0065120910, 0.0069954102,
              0.0074990317, 0.0080231922, 0.0085681248, 0.0091340570, 0.0097212177, 0.0103298230, 0.0109600937,
              0.0116122449, 0.0122864870, 0.0129830306, 0.0137020806, 0.0144438436, 0.0152085144, 0.0159962922,
              0.0168073755, 0.0176419523, 0.0185002182, 0.0193823613, 0.0202885624, 0.0212190095, 0.0221738834,
              0.0231533647, 0.0241576303, 0.0251868572, 0.0262412224, 0.0273208916, 0.0284260381, 0.0295568332,
              0.0307134409, 0.0318960287, 0.0331047624, 0.0343398079, 0.0356013142, 0.0368894450, 0.0382043645,
              0.0395462364, 0.0409151986, 0.0423114114, 0.0437350273, 0.0451862030, 0.0466650836, 0.0481718220,
              0.0497065634, 0.0512694679, 0.0528606549, 0.0544802807, 0.0561284944, 0.0578054339, 0.0595112406,
              0.0612460710, 0.0630100295, 0.0648032799, 0.0666259527, 0.0684781820, 0.0703601092, 0.0722718611,
              0.0742135793, 0.0761853904, 0.0781874284, 0.0802198276, 0.0822827145, 0.0843762159, 0.0865004659,
              0.0886556059, 0.0908417329, 0.0930589810, 0.0953074843, 0.0975873619, 0.0998987406, 0.1022417471,
              0.1046164930, 0.1070231125, 0.1094617173, 0.1119324341, 0.1144353822, 0.1169706732, 0.1195384338,
              0.1221387982, 0.1247718409, 0.1274376959, 0.1301364899, 0.1328683347, 0.1356333494, 0.1384316236,
              0.1412633061, 0.1441284865, 0.1470272839, 0.1499598026, 0.1529261619, 0.1559264660, 0.1589608639,
              0.1620294005, 0.1651322246, 0.1682693958, 0.1714410931, 0.1746473908, 0.1778884083, 0.1811642349,
              0.1844749898, 0.1878207624, 0.1912016720, 0.1946178079, 0.1980693042, 0.2015562356, 0.2050787061,
              0.2086368501, 0.2122307271, 0.2158605307, 0.2195262313, 0.2232279778, 0.2269658893, 0.2307400703,
              0.2345506549, 0.2383976579, 0.2422811985, 0.2462013960, 0.2501583695, 0.2541521788, 0.2581829131,
              0.2622507215, 0.2663556635, 0.2704978585, 0.2746773660, 0.2788943350, 0.2831487954, 0.2874408960,
              0.2917706966, 0.2961383164, 0.3005438447, 0.3049873710, 0.3094689548, 0.3139887452, 0.3185468316,
              0.3231432438, 0.3277781308, 0.3324515820, 0.3371636569, 0.3419144452, 0.3467040956, 0.3515326977,
              0.3564002514, 0.3613068759, 0.3662526906, 0.3712377846, 0.3762622178, 0.3813261092, 0.3864295185,
              0.3915725648, 0.3967553079, 0.4019778669, 0.4072403014, 0.4125427008, 0.4178851545, 0.4232677519,
              0.4286905527, 0.4341537058, 0.4396572411, 0.4452012479, 0.4507858455, 0.4564110637, 0.4620770514,
              0.4677838385, 0.4735315442, 0.4793202281, 0.4851499796, 0.4910208881, 0.4969330430, 0.5028865933,
              0.5088814497, 0.5149177909, 0.5209956765, 0.5271152258, 0.5332764983, 0.5394796133, 0.5457245708,
              0.5520114899, 0.5583404899, 0.5647116303, 0.5711249113, 0.5775805116, 0.5840784907, 0.5906189084,
              0.5972018838, 0.6038274169, 0.6104956269, 0.6172066331, 0.6239604354, 0.6307572126, 0.6375969648,
              0.6444797516, 0.6514056921, 0.6583748460, 0.6653873324, 0.6724432111, 0.6795425415, 0.6866854429,
              0.6938719153, 0.7011020184, 0.7083759308, 0.7156936526, 0.7230552435, 0.7304608822, 0.7379105687,
              0.7454043627, 0.7529423237, 0.7605246305, 0.7681512833, 0.7758223414, 0.7835379243, 0.7912980318,
              0.7991028428, 0.8069523573, 0.8148466945, 0.8227858543, 0.8307699561, 0.8387991190, 0.8468732834,
              0.8549926877, 0.8631572723, 0.8713672161, 0.8796223402, 0.8879231811, 0.8962693810, 0.9046613574,
              0.9130986929, 0.9215820432, 0.9301108718, 0.9386858940, 0.9473065734, 0.9559735060, 0.9646862745,
    ...
    std::string ToString(PixelFormat format)
    {
        switch (format)
        {
            case PixelFormat::U256: return "U256";
            case PixelFormat::Half: return "Half";
    ...
    std::string ImageChannelValues::ToString() const { return ""; }

    std::string ImageChannelDesc::ToString() const { return ""; }

    std::string ImageMetadata::ToString() const { return ""; }

#if 0
    RGBColorSpace const* ImageMetadata::GetColorSpace() const
    {
    ...
    template <typename F>
    void ForExtent(Bounds2i const& extent, WrapMode2D wrapMode, Image const& image, F op)
    {
...
//CHECK_GE(newRes.y, resolution.y);
        ...
        ParallelFor2D(Bounds2i({0, 0}, newRes), [&](Bounds2i outExtent) {
            ...
            Bounds2i inExtent(Point2i(xWeights[outExtent.pMin.x].firstPixel, yWeights[outExtent.pMin.y].firstPixel),
            ...
            for (int yOut = inExtent.pMin.y; yOut < inExtent.pMax.y; ++yOut)
            {
                for (int xOut = outExtent.pMin.x; xOut < outExtent.pMax.x; ++xOut)
                {
                    ...
                    for (int c = 0; c < NChannels(); ++c, ++xBufOffset, ++inOffset)
                        xBuf[xBufOffset] = rsw.weight[0] * inBuf[inOffset] + rsw.weight[1] * inBuf[inOffset + NChannels()] +
...
#if 0
    pstd::vector<Image> Image::GeneratePyramid(Image image, WrapMode2D wrapMode, Allocator alloc)
    {
        ...
        if (!IsPowerOf2(image.resolution[0]) || !IsPowerOf2(image.resolution[1]))
            image = image.FloatResizeUp(Point2i(RoundUpPow2(image.resolution[0]), RoundUpPow2(image.resolution[1])),
                                        wrapMode);
        ...
        for (int i = 0; i < nLevels - 1; ++i)
        {
            ...
            pyramid.push_back(Image(origFormat, image.resolution, image.channelNames, origEncoding, alloc));
            // Initialize _nextImage_ for $i+1$st level
            Point2i nextResolution(std::max(1, image.resolution[0] / 2), std::max(1, image.resolution[1] / 2));
            ...
            int srcDeltas[4] = {0, nChannels, nChannels * image.resolution[0], nChannels * (image.resolution[0] + 1)};
            ...
            ParallelFor(0, nextResolution[1], [&](int64_t y) {
                ...
                for (int x = 0; x < nextResolution[0]; ++x, srcOffset += nChannels)
                    for (int c = 0; c < nChannels; ++c, ++srcOffset, ++nextOffset)
                        nextImage.p32[nextOffset] = (image.p32[srcOffset] + image.p32[srcOffset + srcDeltas[1]] +
    ...
    ImageChannelValues Image::GetChannels(Point2i p, WrapMode2D wrapMode) const
    {
        ...
        switch (format)
        {
            case PixelFormat::U256:
            {
                encoding.ToLinear({&p8[pixelOffset], size_t(NChannels())}, {&cv[0], size_t(NChannels())});
                break;
            }
            case PixelFormat::Half:
            {
    ...
    std::vector<std::string> Image::ChannelNames() const { return {channelNames.begin(), channelNames.end()}; }

    std::vector<std::string> Image::ChannelNames(ImageChannelDesc const& desc) const
    {
    ...
    ImageChannelValues Image::MAE(ImageChannelDesc const& desc, Image const& ref, Image* errorImage) const
    {
    ...
    ImageChannelValues Image::MSE(ImageChannelDesc const& desc, Image const& ref, Image* mseImage) const
    {
    ...
    ImageChannelValues Image::MRSE(ImageChannelDesc const& desc, Image const& ref, Image* mrseImage) const
    {
    ...
    ImageChannelValues Image::Average(ImageChannelDesc const& desc) const
    {
    ...
    void Image::CopyRectOut(Bounds2i const& extent, pstd::span<float> buf, WrapMode2D wrapMode) const
    {
    ...
    void Image::CopyRectIn(Bounds2i const& extent, pstd::span<float const> buf)
    {
        CHECK_GE(buf.size(), extent.Area() * NChannels());
        ...
        switch (format)
        {
            ...
            case PixelFormat::Float:
                ForExtent(extent, WrapMode::Clamp, *this, [&bufIter, this](int offset) { p32[offset] = *bufIter++; });
                break;
    ...
    void Image::SetChannels(Point2i p, ImageChannelValues const& values)
    {
        CHECK_LE(values.size(), NChannels());
        int i = 0;
    ...
    static ImageAndMetadata ReadEXR(std::string const& name, Allocator alloc);
    static ImageAndMetadata ReadPNG(std::string const& name, Allocator alloc, ColorEncoding encoding);
    static ImageAndMetadata ReadPFM(std::string const& filename, Allocator alloc);
    static ImageAndMetadata ReadHDR(std::string const& filename, Allocator alloc);
    static ImageAndMetadata ReadQOI(std::string const& filename, Allocator alloc);
        ...
        else
        {
            ...
            if (data)
            {
                ...
                switch (n)
                {
                    ...
                    case 3:
                        return ImageAndMetadata{Image(std::move(pixels), {x, y}, {"R", "G", "B"}, ColorEncoding::sRGB),
                                                ImageMetadata()};
                    case 4:
                    {
                    ...
                    default: ErrorExit("%s: %d channel image unsupported.", name, n);
                }
            }
            else
    ...
    bool Image::Write(std::string name, ImageMetadata const& metadata) const
    {
        ...
        switch (NChannels())
        {
            case 1:
                // all good; onward
                break;
            case 2: Error("%s: unable to write a 2 channel image in this format.", name); return false;
            case 3:
            {
                ...
                if (!desc)
                    ...
                    Warning(
                        "%s: image has 3 channels but they are not R, G, and B. Image may be "
                        "garbled.",
                        name);
                else
                    // Reorder them as RGB.
            ...
            default:
            {
                ...
                {
                    Error(
                        "%s: multi-channel image does not have R, G, and B. Unable to write to "
                        "this format.",
                        name);
                    return false;
                }
                else
                {
                    std::string err = StringPrintf(
                        "%s: ignoring additional channels for this "
                        "image format: ",
                        name);
                    for (auto const& ch : outImage.ChannelNames())
                        if (ch != "R" && ch != "G" && ch != "B")
        ...
        {
            Warning("%s: converting pixel colors to sRGB to match output image format.", name);
...
// OpenEXR
    ...
    static Imf::FrameBuffer imageToFrameBuffer(Image const& image, ImageChannelDesc const& desc, Imath::Box2i const& dataWindow)
    {
        ...
        // usually makes sense...)
        char* originPtr = (((char*)image.RawPointer({0, 0})) - dataWindow.min.x * xStride - dataWindow.min.y * yStride);
            ...
            case PixelFormat::Half:
                for (int channelIndex : desc.offset)
                    fb.insert(channelNames[channelIndex],
                              Imf::Slice(Imf::HALF, originPtr + channelIndex * sizeof(Half), xStride, yStride));
                break;
            case PixelFormat::Float:
                for (int channelIndex : desc.offset)
                    fb.insert(channelNames[channelIndex],
                ...
                break;
            default: LOG_FATAL("Unexpected image format");
        }
        return fb;
    }
    ...
    static ImageAndMetadata ReadEXR(std::string const& name, Allocator alloc)
    {
        try
        {
            ...
            Imf::FloatAttribute const* renderTimeAttrib = file.header().findTypedAttribute<Imf::FloatAttribute>(
                "renderTimeSeconds");
            if (renderTimeAttrib)
                metadata.renderTimeSeconds = renderTimeAttrib->value();

            Imf::M44fAttribute const* worldToCameraAttrib = file.header().findTypedAttribute<Imf::M44fAttribute>(
                "worldToCamera");
            ...
            Imf::M44fAttribute const* worldToNDCAttrib = file.header().findTypedAttribute<Imf::M44fAttribute>(
                "worldToNDC");
            if (worldToNDCAttrib)
            {
                SquareMatrix<4> m;
            ...
            metadata.fullResolution = Point2i(dispw.max.x - dispw.min.x + 1, dispw.max.y - dispw.min.y + 1);

            Imf::IntAttribute const* sppAttrib = file.header().findTypedAttribute<Imf::IntAttribute>("samplesPerPixel");
            if (sppAttrib)
                metadata.samplesPerPixel = sppAttrib->value();

            Imf::FloatAttribute const* mseAttrib = file.header().findTypedAttribute<Imf::FloatAttribute>("MSE");
            if (mseAttrib)
            ...
            Imf::ChromaticitiesAttribute const*
                chromaticitiesAttrib = file.header().findTypedAttribute<Imf::ChromaticitiesAttribute>("chromaticities");
            if (chromaticitiesAttrib)
            {
                Imf::Chromaticities  c  = chromaticitiesAttrib->value();
                RGBColorSpace const* cs = RGBColorSpace::Lookup(Point2f(c.red.x, c.red.y),
                ...
                {
                    Warning(
                        "Couldn't find supported color space that matches "
                        "chromaticities: "
            ...
            for (auto iter = channels.begin(); iter != channels.end(); ++iter)
            {
                ...
                else
                {
                    ...
                    if (pixelType != iter.channel().type)
                        LOG_FATAL(
                            "ReadEXR() doesn't currently support images with "
    ...
    bool Image::WriteEXR(std::string const& name, ImageMetadata const& metadata) const
    {
        if (Is8Bit(format))
        ...
        try
        {
            ...
            if (metadata.fullResolution)
                ...
                displayWindow = {Imath::V2i(0, 0),
                                 Imath::V2i(metadata.fullResolution->x - 1, metadata.fullResolution->y - 1)};
            else
                displayWindow = {Imath::V2i(0, 0), Imath::V2i(resolution.x - 1, resolution.y - 1)};

            if (metadata.pixelBounds)
                dataWindow = {Imath::V2i(metadata.pixelBounds->pMin.x, metadata.pixelBounds->pMin.y),
                              Imath::V2i(metadata.pixelBounds->pMax.x - 1, metadata.pixelBounds->pMax.y - 1)};
            else
                dataWindow = {Imath::V2i(0, 0), Imath::V2i(resolution.x - 1, resolution.y - 1)};
            ...
            for (auto const& iter : metadata.strings)
                header.insert(iter.first, Imf::StringAttribute(iter.second));
            for (auto const& iter : metadata.stringVectors)
            ...
            {
                RGBColorSpace const& cs = *metadata.GetColorSpace();
    ...
    static ImageAndMetadata ReadPNG(std::string const& name, Allocator alloc, ColorEncoding encoding)
    {
        ...
        unsigned int error = lodepng_inspect(&width, &height, &state, (unsigned char const*)contents.data(), contents.size());
        if (error != 0)
        ...
        switch (state.info_png.color.colortype)
        {
            ...
            case LCT_GREY_ALPHA:
            {
                ...
                error = lodepng::decode(buf, width, height, (unsigned char const*)contents.data(), contents.size(), LCT_GREY, bpp);
                if (error != 0)
                    ErrorExit("%s: %s", name, lodepng_error_text(error));
            ...
            default:
            {
                ...
                error = lodepng::decode(buf,
                                        width,
                                        height,
                                        (unsigned char const*)contents.data(),
                                        contents.size(),
                                        hasAlpha ? LCT_RGBA : LCT_RGB,
                                        bpp);
                if (error != 0)
                    ErrorExit("%s: %s", name, lodepng_error_text(error));
                ...
                {
                    image = Image(PixelFormat::U256, Point2i(width, height), {"R", "G", "B"}, encoding);
                    std::copy(buf.begin(), buf.end(), (uint8_t*)image.RawPointer({0, 0}));
                }
    ...
    Image Image::SelectChannels(ImageChannelDesc const& desc, Allocator alloc) const
    {
        ...
        switch (format)
        {
            case PixelFormat::U256:
                for (int y = 0; y < resolution.y; ++y)
                    for (int x = 0; x < resolution.x; ++x)
                    {
                        uint8_t const* src = (uint8_t const*)RawPointer({x, y});
            ...
            case PixelFormat::Half:
                for (int y = 0; y < resolution.y; ++y)
                    for (int x = 0; x < resolution.x; ++x)
                    {
                        Half const* src = (Half const*)RawPointer({x, y});
            ...
            case PixelFormat::Float:
                for (int y = 0; y < resolution.y; ++y)
                    for (int x = 0; x < resolution.x; ++x)
                    {
                        float const* src = (float const*)RawPointer({x, y});
    ...
    Image Image::Crop(Bounds2i const& bounds, Allocator alloc) const
    {
        CHECK_GT(bounds.Area(), 0);
        CHECK(bounds.pMin.x >= 0 && bounds.pMin.y >= 0);
        Image image(format, Point2i(bounds.pMax - bounds.pMin), channelNames, encoding, alloc);
    ...
    {
        return StringPrintf(
            "[ Image format: %s resolution: %s channelNames: %s "
            "encoding: %s ]",
            format,
            resolution,
            channelNames,
    ...
    bool Image::WritePNG(std::string const& filename, ImageMetadata const& metadata) const
    {
        ...
        switch (NChannels())
        {
            case 1: pngColor = LCT_GREY; break;
            case 3:
                // TODO: it would be nice to store the color encoding used in the PNG metadata...
                pngColor = LCT_RGB;
                break;
            case 4: pngColor = LCT_RGBA; break;
            default: LOG_FATAL("Unexpected number of channels in WritePNG()");
        }

        if (format == PixelFormat::U256)
        {
            error = lodepng_encode_memory(&png, &pngSize, p8.data(), resolution.x, resolution.y, pngColor, 8 /* bitdepth */);
        }
        else
        {
        ...
        if (nOutOfGamut > 0)
            Warning("%s: %d out of gamut pixel channels clamped to [0,1].", filename, nOutOfGamut);
    ...
    bool Image::WriteQOI(std::string const& filename, ImageMetadata const& metadata) const
    {
        Image image     = *this;
        ...
        bool success = WriteFileContents(filename, std::string((char const*)qoiPixels, qoiSize));
        if (!success)
    ...
    static ImageAndMetadata ReadPFM(std::string const& filename, Allocator alloc)
    {
        ...
        for (int y = height - 1; y >= 0; --y)
            if (fread(&rgb32[nChannels * y * width], sizeof(float), nChannels * width, fp) != nChannels * width)
                goto fail;
        ...
        if (nChannels == 1)
            ...
            return ImageAndMetadata{Image(std::move(rgb32), {width, height}, {"R", "G", "B"}), metadata};
    ...
    static ImageAndMetadata ReadHDR(std::string const& filename, Allocator alloc)
    {
        ...
        switch (n)
        {
            case 1: return ImageAndMetadata{Image(std::move(pixels), {x, y}, {"Y"}), ImageMetadata()};
            case 2:
            {
                Image image(std::move(pixels), {x, y}, {"Y", "A"});
                return ImageAndMetadata{image.SelectChannels(image.GetChannelDesc({"Y"})), ImageMetadata()};
            }
            case 3: return ImageAndMetadata{Image(std::move(pixels), {x, y}, {"R", "G", "B"}), ImageMetadata()};
            case 4:
            {
            ...
            default: ErrorExit("%s: %d channel image unsupported.", filename, n);
        }
    }
    ...
    static ImageAndMetadata ReadQOI(std::string const& filename, Allocator alloc)
    {
        ...
        ColorEncoding encoding = (desc.colorspace == QOI_SRGB) ? ColorEncoding::sRGB : ColorEncoding::Linear;

        Image image(PixelFormat::U256, Point2i(desc.width, desc.height), channelNames, encoding, alloc);
        std::memcpy(image.RawPointer({0, 0}), pixels, size_t(desc.width) * size_t(desc.height) * desc.channels);
    ...
    bool Image::WritePFM(std::string const& filename, ImageMetadata const& metadata) const
    {
