...
struct WindowsPlatformMemory {
  ...
  static DMT_FORCEINLINE void* Memzero(void* Dest, size_t Count) {
  ...
  class PlatformVirtualMemoryBlock : public dmt::BasicVirtualMemoryBlock {
   public:
    ...
    PlatformVirtualMemoryBlock(void* InPtr,
                               uint32_t InVMSizeDivVirtualSizeAlignment)
        : BasicVirtualMemoryBlock(InPtr, InVMSizeDivVirtualSizeAlignment) {}
    PlatformVirtualMemoryBlock(PlatformVirtualMemoryBlock const& Other) =
        default;
    PlatformVirtualMemoryBlock& operator=(
        PlatformVirtualMemoryBlock const& Other) = default;
    ...
    static DMT_PLATFORM_API PlatformVirtualMemoryBlock AllocateVirtual(
        size_t Size, size_t InAlignment =
                         PlatformVirtualMemoryBlock::GetVirtualSizeAlignment());
  ...
  [[noreturn]] static DMT_PLATFORM_API void OnOutOfMemory(uint64_t Size,
                                                          uint32_t Alignment);
};
